...
export default class RadioGroup extends Component {
  constructor(props) {
    super(props);
    this.state = {
      radioButtons: this.validate(this.props.radioButtons, this.props?.defaultSelected),
    };
  }

  validate(data, defaultSelected) {
  ...
  render() {
    return (
      <View style={[{justifyContent: this.props.alignItems, alignItems: this.props.alignItems}, this.props?.style]}>
